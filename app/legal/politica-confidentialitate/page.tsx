...
export const metadata: Metadata = {
  ...
  description: "Politica de confidențialitate gobid.ro: prelucrarea datelor cu caracter personal, drepturile vizatului (GDPR), operator, contact.",
  alternates: {
    canonical: `${SITE_URL}/legal/politica-confidentialitate`,
  },
};
...
export default async function PoliticaConfidentialitatePage() {
  ...
  return (
    <article className="prose prose-lg max-w-none dark:prose-invert">
      ...
      <p className="text-sm">
        Date de identificare operator: <Link href="/legal/date-identificare" className="text-blue-600 hover:underline dark:text-blue-400">Date de identificare</Link>
      </p>
      <div
