...
export const metadata: Metadata = {
  ...
  description: "Termenii și condițiile de utilizare a platformei gobid.ro",
  alternates: {
    canonical: `${SITE_URL}/legal/termeni-si-conditii`,
  },
};
...
export default async function TermeniSiConditiiPage() {
  ...
  return (
    <article className="prose prose-lg max-w-none dark:prose-invert">
      ...
      <p className="text-sm">
        Date complete de identificare: <Link href="/legal/date-identificare" className="text-blue-600 hover:underline dark:text-blue-400">Date de identificare</Link>
      </p>
      <div
