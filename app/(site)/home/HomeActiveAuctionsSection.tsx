...
/**
 * Lazy-loaded active auctions (Executări și Insolvență). Fetched in shell via requestIdleCallback.
 * Intentionally lazy: Supabase + heavy card UI isolated to this chunk; improves INP/TBT.
 */
