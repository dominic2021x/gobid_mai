/**
 * API Route - Upload Video pe Platforme Social Media
 * POST /api/video/upload
 * Postează automat clipuri pe TikTok, Instagram Reels și YouTube Shorts
 */
...
export async function POST(request: NextRequest) {
  try {
    ...
    const fullVideoPath = videoPath.startsWith('/')
      ...
      : join(process.cwd(), 'public', 'uploads', videoPath);
