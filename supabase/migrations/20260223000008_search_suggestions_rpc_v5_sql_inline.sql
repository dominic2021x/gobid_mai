-- ============================================
-- Migration v5: funcție rescrisă LANGUAGE sql STABLE pentru plan inline
-- EXPLAIN ANALYZE va arăta Bitmap/Index Scan pe GIN trigram, nu doar FUNCTION SCAN.
...
COMMENT ON FUNCTION public.search_suggestions_rpc(text, text, int) IS
  'v5: LANGUAGE sql STABLE – plan inline, EXPLAIN arată index usage (GIN trigram).';
