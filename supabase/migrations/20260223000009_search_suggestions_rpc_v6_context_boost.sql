-- ============================================
-- Migration v6: parametri context opționali + context_boost (fără filtrare strictă)
-- Backward compatible: category, subcategory, county, city la final cu default null.
-- ============================================
...
COMMENT ON FUNCTION public.search_suggestions_rpc(text, text, int, text, text, text, text) IS
  'v6: context boost (category/subcategory/county/city) – boosting only, no strict filter.';
