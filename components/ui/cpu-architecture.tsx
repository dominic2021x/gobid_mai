...
export interface CpuArchitectureSvgProps {
  ...
  /** Implicit: centrare în container păstrând raportul viewBox. */
...
export default function CpuArchitecture({
  ...
  const id = (name: string) => `cpuarch-${uid}-${name}`;
  ...
  return (
    ...
    >
      ...
      <g mask={u("mask-1")}>
        <circle className="cpu-architecture cpu-line-1" cx="0" cy="0" r="8" fill={u("blue-grad")} />
      </g>
      <g mask={u("mask-2")}>
        <circle className="cpu-architecture cpu-line-2" cx="0" cy="0" r="8" fill={u("yellow-grad")} />
      </g>
      <g mask={u("mask-3")}>
        <circle className="cpu-architecture cpu-line-3" cx="0" cy="0" r="8" fill={u("pinkish-grad")} />
      </g>
      <g mask={u("mask-4")}>
        <circle className="cpu-architecture cpu-line-4" cx="0" cy="0" r="8" fill={u("white-grad")} />
      </g>
      <g mask={u("mask-5")}>
        <circle className="cpu-architecture cpu-line-5" cx="0" cy="0" r="8" fill={u("green-grad")} />
      </g>
      <g mask={u("mask-6")}>
        <circle className="cpu-architecture cpu-line-6" cx="0" cy="0" r="8" fill={u("orange-grad")} />
      </g>
      <g mask={u("mask-7")}>
        <circle className="cpu-architecture cpu-line-7" cx="0" cy="0" r="8" fill={u("cyan-grad")} />
      </g>
      <g mask={u("mask-8")}>
        <circle className="cpu-architecture cpu-line-8" cx="0" cy="0" r="8" fill={u("rose-grad")} />
      </g>

      <g>
        {showCpuConnections && (
          <g fill={u("connection-gradient")}>
        ...
        <rect
          ...
          rx="2"
          fill="#181818"
          filter={u("light-shadow")}
        />
        <text
          x="92"
          y="52.5"
          fontSize="7"
          fill={animateText ? u("text-gradient") : "white"}
          fontWeight="600"
