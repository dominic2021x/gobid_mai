/**
 * VoiceInput.tsx
 * Component pentru înregistrare audio și transcriere cu Whisper API
 * Afișează timer de înregistrare și gestionează permisiuni microfon
 */
...
export default function VoiceInput({
  ...
  const transcribeAudio = async (audioBlob: Blob) => {
    try {
      ...
      if (data.text || data.corrected || data.transcribed) {
        const transcribedText = data.text || data.corrected || data.transcribed;
