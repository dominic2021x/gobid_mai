...
export default function SinglepageParteaStanga() {
  ...
  // Nu returnăm `null` înainte de mount: SSR și primul render client trebuie să aibă același arbore
  // (altfel hydration mismatch lângă conținutul principal live_bid).

  return (
    <aside
      className="pointer-events-none fixed top-28 bottom-6 z-20 hidden xl:flex w-[132px] 2xl:w-[148px]"
      style={{ left: "max(10px, calc((100vw - 80rem) / 2 - 160px))" }}
    >
